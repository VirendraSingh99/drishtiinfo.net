...
const AboutUsPage = () => {
  ...
  return (
    <html lang="en">
      <head>
        <title>About | Drishti Infotech HRMS Software & HR Solutions</title>
              ...
              <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 sm:py-28 lg:py-32">
                <div className="text-center text-black">
                  ...
                  <p className="text-lg sm:text-xl text-white text-opacity-95 max-w-3xl mx-auto mb-8 leading-relaxed">
                    We are a leading software development company specializing
                    in creating powerful, scalable, and user-friendly solutions
                  ...
                  {activeTab === "mission" && (
                    <div className="animate-fadeIn">
                      ...
                      <p className="text-lg text-gray-700 leading-relaxed mb-6">
                        ...
                        scalable, and user-friendly software solutions that
                        drive digital transformation and sustainable growth. We
                        are committed to delivering excellence through
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Putting client needs at the forefront of
                              everything we do
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Leveraging latest technologies for competitive
                              advantage
                            </p>
                          </div>
                        </div>
                  ...
                  {activeTab === "vision" && (
                    <div className="animate-fadeIn">
                      ...
                      <p className="text-lg text-gray-700 leading-relaxed mb-6">
                        ...
                        innovative technology solutions. We envision a future
                        where every business, regardless of size, has access to
                        world-class software that propels them toward success.
                      </p>
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="flex items-start gap-3">
                          <CheckCircle className="w-6 h-6 text-red-500 flex-shrink-0 mt-1" />
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Serving businesses across continents and
                              industries
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Setting industry standards for excellence and
                              innovation
                            </p>
                          </div>
                        </div>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  <div className="group bg-gray-100 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      24/7 customer support and dedicated account managers to
                      ensure your success at every step of the journey.
                    </p>
                  </div>
                  ...
                  <div className="group bg-gray-100 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      build scalable, future-proof solutions for your business.
                    </p>
                  </div>
                  ...
                  <div className="group bg-gray-100 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      We focus on delivering measurable results that align with
                      your business objectives and drive real growth.
                    </p>
                  </div>
                  ...
                  <div className="group bg-gray-100 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Enterprise-grade security measures and data protection
                      protocols to keep your business safe and compliant.
                    </p>
                  </div>
            ...
            <div className="bg-gray-100 py-16 sm:py-20">
              <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="https://kanakdrishtiinfo.com/">
