          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="z-10 order-1 lg:order-2">
              ...
              <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-xl">
                Streamline your entire employee lifecycle from hire to retire.
                Automate payroll, track attendance, and boost engagement with
                the most intuitive HRMS on the market.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="max-w-3xl mb-20">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Our HRMS is built to eliminate manual processes, improve accuracy,
              and empower HR teams with real-time insights. From daily
              attendance to complex payroll and compliance, everything works
              together seamlessly on a single, intelligent platform.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Manage everything from employee onboarding to exit formalities
                with structured workflows. Maintain centralized employee
                records, roles, documents, and performance history in one secure
                system.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Track attendance using biometric, facial recognition, or mobile
                geo-fencing. Automate leave approvals, holiday calendars, and
                attendance rules without spreadsheets.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Run accurate payroll with built-in PF, ESI, tax calculations,
                bonus, incentives, and deductions. Generate compliance-ready
                reports with complete audit trails.
              </p>
            </div>
          </div>
          ...
          <div className="mt-20 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-6">
                ...
                employees, our HRMS scales effortlessly with your organization.
                Automated workflows reduce human errors, while real-time
                analytics ensure every decision is backed by reliable data.
              </p>
              <p className="text-slate-600 text-lg leading-relaxed">
                With role-based access control, cloud security, and continuous
                system updates, your HR operations remain compliant, secure, and
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-3xl mb-20">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Our HRMS is designed to simplify complex HR operations by bringing
              employee management, payroll, attendance, and compliance into a
              single, easy-to-use system. Built for growing organizations that
              demand accuracy, automation, and scalability.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all border border-slate-100">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Track attendance using biometric, facial recognition, or mobile
                punch-in with real-time leave balance updates.
              </p>
            </div>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all border border-slate-100">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                Create flexible shifts, manage overtime, and optimize workforce
                planning with real-time visibility.
              </p>
            </div>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all border border-slate-100">
              ...
              <h3 className="text-xl font-bold mb-3">Compliance & Security</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Stay compliant with PF, ESI, TDS and labor laws while keeping
                employee data protected with enterprise-grade security.
              </p>
            </div>
      ...
      <section className="py-28 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="max-w-3xl mb-20">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              We don’t just provide HR software — we deliver a complete people
              management ecosystem designed to save time, reduce costs, and
              empower your HR team with real insights.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  Get your HRMS up and running in days, not months — with guided
                  onboarding and zero disruption to your operations.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  Powerful dashboards and reports help leadership make smarter,
                  faster people decisions.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  Simple, intuitive UI that HR teams love — minimal training,
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  Cloud-based architecture ensures 99.9% uptime and seamless
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  Trusted by 500+ organizations to reduce HR workload, improve
                  accuracy, and scale confidently.
                </p>
              </div>
            </div>
          </div>
