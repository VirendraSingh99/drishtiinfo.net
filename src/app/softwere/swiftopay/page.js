          ...
          <div className="grid lg:grid-cols-2 gap-14 xl:gap-24 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl md:text-2xl text-slate-600 font-light leading-relaxed max-w-xl">
                ...
                across multiple gateways in real time. Built for speed, scale,
                and reliability — helping businesses boost success rates and
                reduce transaction costs globally.
              </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="group p-10 rounded-3xl bg-white shadow-xl shadow-red-100 hover:shadow-red-200 transition-all">
              ...
              <p className="text-gray-600 leading-relaxed">
                AI-driven routing ensures every transaction is processed through
                the most efficient and high-performing gateway in real time.
              </p>
            </div>
            ...
            <div className="group p-10 rounded-3xl bg-white shadow-xl shadow-red-100 hover:shadow-red-200 transition-all">
              ...
              <p className="text-gray-600 leading-relaxed">
                PCI-DSS compliance, tokenization, AI-based fraud prevention, and
                end-to-end encryption secure every payment.
              </p>
            </div>
            ...
            <div className="group p-10 rounded-3xl bg-white shadow-xl shadow-red-100 hover:shadow-red-200 transition-all">
              ...
              <p className="text-gray-600 leading-relaxed">
                Sub-200ms API response times with real-time WebSocket support
            ...
            <div className="group p-10 rounded-3xl bg-white shadow-xl shadow-red-100 hover:shadow-red-200 transition-all">
              ...
              <p className="text-gray-600 leading-relaxed">
                Advanced dashboards provide instant visibility into success
                rates, settlements, and performance metrics.
              </p>
            </div>
            ...
            <div className="group p-10 rounded-3xl bg-white shadow-xl shadow-red-100 hover:shadow-red-200 transition-all">
              ...
              <p className="text-gray-600 leading-relaxed">
                Developer-friendly SDKs, APIs, and no-code workflows ensure fast
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="space-y-10">
              ...
              <h2 className="text-5xl font-black leading-tight text-gray-900">
                One Platform.
                <br />
                <span className="text-red-500">Infinite Possibilities.</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="bg-red-500 rounded py-8 px-8 md:px-16   text-white">
            <h2 className="text-3xl md:text-4xl font-black mb-8 leading-tight">
              Ready to <span className="italic">Orchestrate</span>
              <br />
              the Future?
            </h2>
            <p className="text-xl md:text-2xl text-red-100 mb-12 max-w-2xl mx-auto opacity-90">
              Join hundreds of growing businesses who already reduced costs and
              boosted conversions.
            </p>
            <button className="px-14 py-3 bg-white text-red-700 rounded-2xl font-black text-xl shadow-2xl hover:bg-red-50 hover:scale-105 active:scale-100 transition-all duration-300">
