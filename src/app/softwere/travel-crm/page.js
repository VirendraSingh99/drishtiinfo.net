...
const TravelCRMDetails = () => {
  ...
  return (
    <html lang="en">
      <head>
        <title>
          Travel CRM | Drishti Infotech HRMS Software & HR Solutions
        </title>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  <div>
                    ...
                    <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                      The all-in-one CRM designed for modern travel agencies.
                      Automate your bookings, generate itineraries, and grow
                      your sales with Kanak Drishti's Travel Solutions.
                    </p>
                  ...
                  <div className="relative flex justify-center">
                    <div className="rounded-3xl p-2 relative z-10 w-full max-w-[650px] lg:max-w-[750px]">
                      <img
                        ...
                        className="rounded-2xl w-full max-w-full transform scale-105 lg:scale-110 transition-transform duration-500"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="text-center max-w-4xl mx-auto mb-14">
                  ...
                  <p className="text-slate-600 text-base md:text-lg leading-relaxed">
                    DRISHTI Travel CRM Software revolutionizes travel agency
                    operations with comprehensive customer management, booking
                    automation, and business intelligence. From lead generation
                    to post-trip follow-ups, our platform streamlines every
                    aspect of your travel business.
                  </p>
                  <p className="text-slate-600 text-base md:text-lg leading-relaxed mt-4">
                    Handle domestic and international bookings, manage multiple
                    suppliers, track commissions, and deliver personalized
                    travel experiences. Our Travel CRM adapts to your business
                    size while maintaining enterprise-grade security and
                    performance.
                  </p>
                </div>
                ...
                <div className="mb-16">
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {[
                      "Manage customer queries from single dashboard",
                      "Send multiple travel quotations per inquiry",
                      "Import PNR directly into CRM",
                      "Advanced itinerary & quotation builder",
                      "Booking & payment tracking",
                      "WhatsApp & email automation",
                      "Multiple travel agent access",
                    ].map((item, i) => (
                      <div
                        key={i}
                        className="bg-[#EAF2FF] rounded-xl px-5 py-4 
                 min-h-[72px] 
                 flex items-start gap-3"
                      >
                        {/* ICON */}
                        <span
                          className="mt-[2px] w-5 h-5 rounded-full bg-red-500 
                       ...
                       text-white text-xs flex-shrink-0"
                        ...
                        {/* TEXT */}
                        <p className="text-slate-700 text-sm leading-snug text-left">
                          {item}
                        </p>
                      </div>
                    ))}
                ...
                {/* ---------- WHY CHOOSE ---------- */}
                <div className="bg-red-500 rounded p-8 md:p-10">
                  <h3 className="text-xl font-bold text-white mb-6">
                    Why Choose DRISHTI Travel CRM?
                  </h3>

                  <ul className="space-y-3 text-white text-sm md:text-base">
                    <li>
                      • <strong>Complete Travel Solution:</strong> End-to-end
                      CRM for travel agencies & tour operators.
                    </li>
                    <li>
                      • <strong>Boost Bookings:</strong> Increase conversions
                      with seamless booking experience.
                    </li>
                    <li>
                      • <strong>Customer Insights:</strong> Track preferences,
                      history & personalized offers.
                    </li>
                    <li>
                      • <strong>Scalable Operations:</strong> Perfect for small
                      agencies to large tour operators.
                    </li>
                    <li>
                      • <strong>Revenue Focused:</strong> Dynamic pricing &
                ...
                <p className="text-xs text-slate-500 mt-6 text-center">
                  Grow your travel business with DRISHTI Travel CRM – the
                  complete solution for modern travel agencies.
                </p>
              </div>
            </section>
              ...
              <div className="max-w-7xl mx-auto px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                  ...
                  <p className="text-slate-500">
                    Built by experts who understand the complexity of
                    itineraries, payments, and client management.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                  {features.map((item, idx) => (
                    <div
                      key={idx}
                      className="group p-8 bg-white border border-red-600 rounded-[32px] hover:border-red-100 hover:bg-red-50/30 transition-all duration-300"
                    >
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  <div>
                    <h2 className="text-3xl lg:text-4xl font-bold mb-8 text-black leading-tight">
                      Simplify your <br />
                      <span className="text-red-500">Lead-to-Booking</span>{" "}
                      Journey
                    </h2>
